    ...
    <div className="min-h-screen bg-[#FFC803] px-4 sm:px-8 lg:px-20 py-8 md:py-12">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          Back to Blogs */}
          <button className="mb-8 btn-animated min-w-[120px] sm:min-w-[150px] md:min-w-[180px] rounded py-[13px] font-body text-base text-[10px] sm:text-sm md:text-lg">
        ...
        <div
          className="bg-[#FD5A17] aspect-video border-2 border-black/50 rounded-xl p-3 sm:p-6 mb-8"
          style={{ boxShadow: '8px 8px 0 0 #000' }}
        >
          <img
            src={blog!.image}
        ...
        <div
          className="bg-[#FD5A17] border-2 border-black/50 rounded-xl p-3 md:p-6 mb-8"
          style={{ boxShadow: '8px 8px 0 0 #000' }}
        >
          ...
          <ul className="list-disc pl-8 mb-5 space-y-3">
            <li className="text-sm md:text-lg leading-relaxed">Share your knowledge and expertise with the world</li>
            <li className="text-sm md:text-lg leading-relaxed">Build a personal or professional brand</li>
            <li className="text-sm md:text-lg leading-relaxed">Create multiple income streams through monetization</li>
            <li className="text-sm md:text-lg leading-relaxed">Connect with like-minded people in your niche</li>
            <li className="text-sm md:text-lg leading-relaxed">Improve your writing and communication skills</li>
          </ul>
          ...
          <div style={{ fontFamily: 'var(--font-questrial)' }} className="bg-[#FFC803] border-2 border-black rounded-xl p-6 my-8">
            <p className="text-sm md:text-lg font-medium m-0">
          ...
          <ol className="list-decimal pl-8 mb-5 space-y-3">
            <li className="text-sm md:text-lg leading-relaxed"><strong>Choose a platform:</strong> WordPress, Wix, or Squarespace are popular options</li>
            <li className="text-sm md:text-lg leading-relaxed"><strong>Pick a domain name:</strong> Make it memorable and relevant to your niche</li>
            <li className="text-sm md:text-lg leading-relaxed"><strong>Select hosting:</strong> Invest in reliable hosting for better performance</li>
            <li className="text-sm md:text-lg leading-relaxed"><strong>Design your site:</strong> Choose a clean, professional theme</li>
            <li className="text-sm md:text-lg leading-relaxed"><strong>Create essential pages:</strong> About, Contact, and Privacy Policy</li>
          </ol>
        ...
        {/* Related Posts */}
        <div
          className="bg-[#FD5A17] border-2 border-black rounded-xl p-8 md:p-10"
          style={{ boxShadow: '8px 8px 0 0 #000' }}
        >
          <h3
            style={{ fontFamily: 'var(--font-ghuthen)' }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {blogs.filter(i => i.slug !== blog.slug).map((i, index) => (
              <BlogCard key={index} blog={i} index={index} />
            ))}
          </div>
        </div>
