  ...
  return (
    ...
    lg:bg-size-[1400px_auto]">
      <div className="relative w-full h-full px-4 sm:px-8 lg:px-20 py-8 md:py-16 lg:py-20">
        ...
        <div className="flex flex-col max-lg:mr-2 h-full lg:flex-row justify-center items-stretch gap-6 md:gap-8 my-8 md:my-12 lg:my-16">

          <div className=" h-full">
            <div
              className="bg-[#FD5A17] rounded-xl border-2 border-black/50 py-8 md:py-10 lg:py-13 px-8 md:px-7 xl:px-10"
          ...
          <div id="blogs" className="max-h-full lg:flex-1 relative">
            <div
                    ...
                    <div key={_} className="min-w-52  sm:min-w-[278px] snap-start">
                      <div className="bg-black rounded-lg border border-black overflow-hidden h-full flex flex-col">
                        ...
                        <div className="bg-[#FFC803] p-4 sm:p-9 border-b border-white">
                          <div className="dh-40 bg-white rounded-xl border-2 border-black overflow-hidden">
                            <Image
                              src={i.image}
                              alt="Blog thumbnail"
                              width={200}
